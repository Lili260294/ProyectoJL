...
namespace ProyectoJL.Controllers
{
    public class InventariosController : Controller
    {
        ...
        public InventariosController(ProyectJLContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Inventarios != null ? 
                          ...
                          Problem("Entity set 'ProyectJLContext.Inventarios'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProyectJLContext.Inventarios'  is null.");
            }
            var inventario = await _context.Inventarios.FindAsync(id);
            if (inventario != null)
            {
